...
interface ResultBuilder {
    ...
    fun add(content: ResultBuilder)

}

class StringResultBuilder : ResultBuilder {
    val stB = StringBuilder()
    override val length: Long
        get() = stB.length.toLong()

    override val value: String
        get() = stB.toString()

    override fun add(content: ResultBuilder) {
        stB.append(content.value)
    }
...
class LengthResultBuilder : ResultBuilder {

    override var length: Long = 0
        private set

    override fun add(content: String) {
        length += content.length.toLong()
    }
    ...
    override val value: String
        get() = error("This class is only for length")
}
